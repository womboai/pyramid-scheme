...
impl<E> IntoResponse for ErrorWrapper<E> where E : Display {
...
pub(crate) async fn last_n_bits(TypedHeader(range): TypedHeader<Range>) -> Result<Ranged<KnownSize<File>>, ErrorWrapper<io::Error>> {
